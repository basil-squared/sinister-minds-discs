    ...
    fun register() {
        ...
        LootTableEvents.MODIFY.register {key, tableBuilder, source, registries ->
                if (source.isBuiltin && NETHER_BRIDGE_CHEST_ID == key) {
                   ...
                   addToPool(poolBuilder,ModItems.WELCOME_HOME_DISC_ITEM,5)
                    addToPool(poolBuilder,ModItems.I_MISS_THE_QUIET_DISC_ITEM,5)
                    addToPool(poolBuilder,ModItems.YOU_MUST_ANSWER_DISC_ITEM, 5)
                    addToPool(poolBuilder, ModItems.MINDS_DISC_ITEM, 5)
